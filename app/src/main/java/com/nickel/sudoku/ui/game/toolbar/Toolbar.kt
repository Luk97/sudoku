...
internal fun Toolbar(
    ...
    Column {
        Row {
            ...
            ToolbarButton(icon = Icons.AutoMirrored.Filled.Undo, enabled = buttonAvailability.undoActionsAvailable) {
        ...
        Row {
            ...
            ToolbarButton(icon = Icons.AutoMirrored.Filled.Redo, enabled = buttonAvailability.redoActionsAvailable) {
        ...
        Row {
            ...
            ToolbarButton(icon = Icons.Default.Delete, enabled = buttonAvailability.removeDigitsAvailable) {
